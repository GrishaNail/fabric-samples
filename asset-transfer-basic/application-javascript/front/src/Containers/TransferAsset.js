  ...
  render() {
    ...
    return (
      <form className="Main-inside" noValidate autoComplete="off">
        <Typography variant="display2">Transfer asset</Typography>
        <TextField
          label="ASSET ID"
        ...
        >
          {this.props.connected ? "TRANSFER ASSET" : "DISCONNECTED"}
        </Button>
        <p>Asset ID is case sensitive must be valid</p>
      </form>
    );
  }
}

export default withStyles(styles)(TransferAsset);
